...
method, since any equivalent extract carrying the columns below reproduces the analysis.
...
| `bc_boundary_3005.geojson` | n/a | 1 MB | yes | Natural Earth 1:50m admin-1, public domain, dissolved to BC, reprojected to EPSG:3005, simplified 500 m. **Not yet used**, but intended to give Figure 6 a basemap |
